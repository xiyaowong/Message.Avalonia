...
{
    /// <summary>
    /// Shows a warning message with the specified message.
    /// </summary>
    ...
    /// <summary>
    /// Shows a warning message with customizable options.
    /// </summary>
    /// <param name="message">The warning message to display</param>
    ...
    /// <summary>
    /// Shows a warning message with a list of action buttons.
    /// </summary>
    /// <param name="message">The warning message to display</param>
    ...
    /// <summary>
    /// Shows a warning message with customizable options and action buttons.
    /// </summary>
    /// <param name="message">The warning message to display</param>
    /// <param name="options">Custom options for configuring the message</param>
    /// <param name="items">A list of action button labels</param>
